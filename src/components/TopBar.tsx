  ...
  return (
    <header className="moments-topbar">
      <div className="moments-topbar-left">
        ...
        <span className="moments-brand" aria-label="Moments">
          <img className="moments-brand-mark" src="/favicon.svg" width={28} height={28} alt="" decoding="async" />
          <span className="moments-logo">MOMENTS</span>
        </span>
      </div>
